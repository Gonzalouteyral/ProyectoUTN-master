...
async function buscarNovedades(busqueda) {
  var query = "select * from galeria where titulo like ? OR img_id like ?";
...
module.exports = { getNovedades, insertNovedades, deleteNovedadesById, getNovedadesById, modificarNovedadesById, buscarNovedades }